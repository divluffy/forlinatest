...
function Filter() {
  ...
  const ListOfCategory = [
    { title: "Coat and Jackets", sections: ["type 1 ", "type 2", "type 3"] },
    {
      title: "Dressses",
      sections: ["type 1 ", "type 2", "type 3", "type 4", "type 5"],
    },
    { title: "Playsuit", sections: ["type 1 ", "type 2", "type 3"] },
    {
      title: "Short",
      sections: [
        "type 1 ",
    ...
    { title: "Top", sections: ["type 1 ", "type 2", "type 3"] },
    { title: "Bottoms", sections: ["type 1 ", "type 2", "type 3"] },
  ];
  ...
  const ListOfProducts = [
    {
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/81-ib10h7gL._AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "1",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/71eMTvCGloL._AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "2",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/51kCDqE1X5L._AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "3",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/61h8YrX-h3L._MCnd_AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "4",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/51JGinU7-RL._AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "5",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/715QMANyHML._AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "6",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/61ppE6kYVyL._MCnd_AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "7",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/61pP5gObVXL._AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "8",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/71BWLH21E2L._AC_UL480_FMwebp_QL65_.jpg",
    },
    {
      id: "9",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/61JVYr9m+CL._AC_UY327_FMwebp_QL65_.jpg",
    },
    {
      id: "10",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/61JZTcdfFBL._AC_UY327_FMwebp_QL65_.jpg",
    },
    {
      id: "11",
      title: "Urbano Jacket",
      ...
      price: "99",
      cover:
        "https://m.media-amazon.com/images/I/81GEK9f24YL._AC_UL480_FMwebp_QL65_.jpg",
    },
  ];
    ...
    <Container>
      <Filters>
        ...
        <Categories>
          ...
          {ListOfCategory.map(({ title, sections }, i) => {
            return (
              <LineCategory key={i}>
                <div
                  onClick={() => {
                    isOpenCategory === title
                      ? setIsOpenCategory("")
                      : setIsOpenCategory(title);
                  }}
                ...
                {isOpenCategory === title && (
                  <div className="category_sections">
                    {sections.map((item, i) => {
      ...
      <Products>
        {ListOfProducts.map(({ id, cover, price, note, rate, title }) => {
          return (
            <Product key={id}>
              <Link to="">
                <img src={cover} alt="" />
